        ...
        <div className="flex h-16 items-center justify-between px-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              {isAuthenticated ? (
                <Link href="/dashboard">
                  <Button className="px-5 py-2 transition-all duration-200 hover:scale-105">
                    Dashboard
                  </Button>
                </Link>
              ) : (
                <>
                  <Link href="/signin">
                    <Button
                      variant="outline"
                      className="px-5 transition-all duration-200 hover:bg-secondary"
                    >
                      Sign In
                    </Button>
                  </Link>
          ...
          <Drawer open={open} onOpenChange={setOpen} direction="left">
            <DrawerTrigger asChild>
              <Button
                ...
                className="hover:bg-secondary/50 h-10 w-10"
              >
