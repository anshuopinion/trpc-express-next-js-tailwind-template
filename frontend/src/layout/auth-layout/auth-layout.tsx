  ...
  return (
    <div className="flex min-h-screen relative overflow-hidden bg-muted/5">
      ...
      >
        <div className="max-w-[440px] relative z-10 ">
          ...
          <p className="text-lg text-muted-foreground max-w-[400px]">
            Real-time stock monitoring platform with advanced filtering capabilities. Create custom
            scanners, set alerts, and never miss trading opportunities.
          </p>
        </div>
      ...
      <motion.div
        ...
        className={cn(
          "flex-1 px-6 py-8 bg-background relative z-10",
          "md:px-12 md:py-12",
          "lg:px-24 lg:border-l lg:border-border"
        )}
      >
        <div className="max-w-[440px] mx-auto w-full  ">
          <div className="mb-6 hidden md:block">
            ...
            <p className="text-muted-foreground mt-1">
              Access your trading dashboard and scanner tools
            </p>
          </div>
          {children}
        </div>
